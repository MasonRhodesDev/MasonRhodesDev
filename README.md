...
- [**hyprstate**](https://github.com/MasonRhodesDev/hyprstate): Session state machine for lid events, monitor profiles, lock, suspend, and USB wake <sub>[v2.1.1](https://github.com/MasonRhodesDev/hyprstate/releases/latest) · pushed today</sub>
...
- [**hyprnotice**](https://github.com/MasonRhodesDev/hyprnotice): Notification daemon with an inbox that keeps action buttons available after the popup is gone <sub>pushed May 2026</sub>
...
- [**waybar-workspace-buttons**](https://github.com/MasonRhodesDev/waybar-workspace-buttons): Event-driven workspace buttons for Waybar, no polling or shelling out <sub>pushed today</sub>
- [**linux-multi-theme-toggle**](https://github.com/MasonRhodesDev/linux-multi-theme-toggle): Whole-desktop light/dark switching with Material You colors <sub>[v0.1.0](https://github.com/MasonRhodesDev/linux-multi-theme-toggle/releases/latest) · pushed today</sub>
